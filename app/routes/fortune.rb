class FeelGoodBot < Sinatra::Base
  get '/fortunes' do
  	@fortune = ["You laugh now, wait til you get home", "Could I get directions? To your heart?", "Try a different career.", "Your resemblance to a muppet will prevent the world from taking you seriously.", "Run.", "If a pigeon poops on you, do not blame the pigeon, blame the poop.
